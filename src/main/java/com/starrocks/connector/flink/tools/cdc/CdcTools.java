...
import com.starrocks.connector.flink.tools.cdc.mysql.MysqlDatabaseSync;
...
public class CdcTools {
    ...
    private static void createMySQLSyncDatabase(String[] opArgs) throws Exception {
        ...
        if(StringUtils.isNullOrWhitespaceOnly(jobName)){
            jobName = String.format("MySQL-StarRocks Sync Database: %s", mysqlMap.get("database-name"));
        }
        env.execute(jobName);
    }
