...
import com.starrocks.connector.flink.catalog.starrocks.StarRocksType;
...
public class MysqlType {
    ...
    public static String toStarRocksType(String type, Integer length, Integer scale) {
        switch (type.toUpperCase()) {
            ...
            case DATETIME:
            case TIMESTAMP:
                return String.format("%s", StarRocksType.DATETIME);
            case CHAR:
                Preconditions.checkNotNull(length);
                return String.format("%s(%s)", StarRocksType.CHAR, length);
            case VARCHAR:
                Preconditions.checkNotNull(length);
